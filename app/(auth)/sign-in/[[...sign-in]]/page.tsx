            ...
            <div className='flex flex-col  items-center py-4 space-y-4 min-h-screen'>
              <div className='w-[80vw] max-w-[400px] pt-8 space-y-4'>
                ...
                <div className={`text-xl text-center ${textFont.className}`}>
                  Talk to ChatGPT, GPT-4o, Claude 3 Opus, DALLE 3, and millions
                  of others - all on EchoChat.
                </div>
                <div className='flex flex-col pt-6 space-y-6'>
                  <Button
                    className={`bg-white  text-black rounded-3xl hover:bg-black/10 border p-4 h-11 ${buttonFont.className}`}
                ...
                <Button
                  onClick={onClick}
                  className={`bg-violet-400  text-white hover:bg-violet-600 rounded-3xl border p-4 w-full h-11 ${buttonFont.className}`}
                >
                  Go
                </Button>
              </div>
        ...
        <>
          <div className='flex flex-col  w-full min-h-screen items-center justify-center'>
            <div className='w-[80vw] md:max-w-[400px] space-y-2'>
              ...
              <h1 className={`text-2xl ${textFont.className}`}>Verify Email</h1>
              ...
              />
              <Button
                className={`bg-transparent  text-black text-md hover:bg-black/5 rounded-3xl shadow-none p-4 w-full h-11 ${buttonFont.className}`}
              >
                Resend Code
              </Button>
              <Button
                className={`bg-violet-400  text-white text-md hover:bg-violet-600 rounded-3xl border p-4 w-full h-11 ${buttonFont.className}`}
                onClick={() =>
                  handleSesClick('credentials', inputCode, emailAddress)
                }
              >
                Verify
              </Button>
